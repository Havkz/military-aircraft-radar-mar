...
final class L10n {
    ...
    static String t(Context c, String key) {
        switch (key) {
            ...
            case "adsb_recommended": return v(c,"ADS-B Exchange is recommended because some aircraft are not visible on Flightradar24.","推荐使用 ADS-B Exchange，因为部分飞机在 Flightradar24 上不可见。","ADS-B Exchange की सलाह दी जाती है, क्योंकि कुछ विमान Flightradar24 पर दिखाई नहीं देते।","Se recomienda ADS-B Exchange porque algunos aviones no aparecen en Flightradar24.","ADS-B Exchange est recommandé, car certains aéronefs ne sont pas visibles sur Flightradar24.","يُنصح باستخدام ADS-B Exchange لأن بعض الطائرات لا تظهر على Flightradar24‏‎.","ADS-B Exchange ব্যবহার করার পরামর্শ দেওয়া হয়, কারণ কিছু বিমান Flightradar24-এ দেখা যায় না।","O ADS-B Exchange é recomendado porque algumas aeronaves não aparecem no Flightradar24.","Рекомендуется ADS-B Exchange, поскольку некоторые борты не отображаются во Flightradar24.","ADS-B Exchange wird empfohlen, da manche Flugzeuge auf Flightradar24 nicht sichtbar sind.");
