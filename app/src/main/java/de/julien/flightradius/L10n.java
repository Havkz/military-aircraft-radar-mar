...
final class L10n {
    ...
    static String t(Context context, String key) {
        switch (key) {
            ...
            case "legal_data": return "Contains information from ADSB.lol, Airplanes.live, and optionally ADS-B Exchange. Registration countries may be inferred from ICAO 24-bit state allocations and can differ from the operator or current base. Data is provided as-is and may be incomplete or inaccurate.";
