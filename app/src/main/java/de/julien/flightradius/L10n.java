...
final class L10n {
    ...
    static String t(Context c, String key) {
        switch (key) {
            ...
            case "adsb_recommended": return v(c,"ADS-B Exchange is recommended, as some aircraft may not be visible on Flightradar24.","推荐使用 ADS-B Exchange，因为部分飞机可能无法在 Flightradar24 上显示。","ADS-B Exchange की सलाह दी जाती है, क्योंकि कुछ विमान Flightradar24 पर दिखाई न दें।","Se recomienda ADS-B Exchange, ya que es posible que algunas aeronaves no sean visibles en Flightradar24.","ADS-B Exchange est recommandé, car certains aéronefs peuvent ne pas être visibles sur Flightradar24.","يُنصح باستخدام ADS-B Exchange، إذ قد لا تكون بعض الطائرات مرئية على Flightradar24‏‎.","ADS-B Exchange ব্যবহারের পরামর্শ দেওয়া হয়, কারণ কিছু বিমান Flightradar24-এ দৃশ্যমান নাও হতে পারে।","O ADS-B Exchange é recomendado, pois algumas aeronaves podem não estar visíveis no Flightradar24.","Рекомендуется ADS-B Exchange, поскольку некоторые воздушные суда могут не отображаться во Flightradar24.","ADS-B Exchange wird empfohlen, da einige Luftfahrzeuge auf Flightradar24 möglicherweise nicht sichtbar sind.");
            ...
            case "restart_description": return v(c,"Reminder to restart monitoring after a device reboot","设备重启后提醒重新启动监控","डिवाइस पुनः आरंभ होने के बाद निगरानी पुनः शुरू करने का अनुस्मारक","Recordatorio para reiniciar la supervisión después de reiniciar el dispositivo","Rappel de redémarrage de la surveillance après le redémarrage de l’appareil","تذكير بإعادة تشغيل المراقبة بعد إعادة تشغيل الجهاز","ডিভাইস পুনরায় চালু হওয়ার পর মনিটরিং পুনরায় চালুর অনুস্মারক","Lembrete para reiniciar o monitoramento após a reinicialização do dispositivo","Напоминание о возобновлении мониторинга после перезагрузки устройства","Erinnerung zum erneuten Start der Überwachung nach einem Geräteneustart");
            ...
            case "tap_open_radar": return v(c,"Open radar","打开雷达","रडार खोलें","Abrir el radar","Ouvrir le radar","فتح الرادار","রাডার খুলুন","Abrir o radar","Открыть радар","Radar öffnen");
            default: return key;
        }
    }
