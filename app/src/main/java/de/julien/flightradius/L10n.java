...
final class L10n {
    ...
    static String t(Context context, String key) {
        switch (key) {
            ...
            case "legal_data": return "Contains information from ADSB.lol, which is made available under the Open Database License (ODbL) 1.0. Data is provided as-is and may be incomplete or inaccurate.";
