...
final class L10n {
    ...
    static String t(Context context, String key) {
        switch (key) {
            ...
            case "legal_data": return "Contains information from ADSB.lol, Airplanes.live, authorized embedded Flightradar24 and ADS-B Exchange visible-map sessions on Android, and callsign route or airline data from ADSB.lol VRS standing data and ADSBDB. Registration countries may be inferred from ICAO 24-bit state allocations and can differ from the operator or current base. Routes are plausibility-checked against the live aircraft position and direction but may still be incomplete or inaccurate. Data is provided as-is.";
