...
The GitHub Actions workflow can also create an **unsigned** IPA for release assets without Apple credentials. This is a real device build, but iOS will reject it until a user signs it for their own device with an Apple-ID-based sideloading tool or a valid provisioning profile.
