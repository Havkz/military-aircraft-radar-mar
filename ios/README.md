...
The simulator CI definition is stored at `ci/ios-build.yml.example`. Copy it to `.github/workflows/ios-build.yml` after authenticating GitHub CLI with the `workflow` scope.
